...
namespace PK.Utils.Synchronization
{
    ...
    public static class WaitHandleExtensions
    {
        private class RegisteredWaitHandleWrapper : IDisposable
        {
            ...
            public RegisteredWaitHandleWrapper([NotNull] RegisteredWaitHandle registeredWaitHandle, [NotNull] WaitHandle waitHandle, CancellationToken cancellationToken)
            {
                _registeredWaitHandle = registeredWaitHandle ?? throw new ArgumentNullException(nameof(registeredWaitHandle));
        ...
        public static IDisposable RegisterCallback(this WaitHandle handle, WaitOrTimerCallback callback, object state, CancellationToken cancellationToken)
        {
